...
If you'd like to have a better true negative rate, which models would you choose and how would you go about doing this in a less manual way (you don't need to write code to do it - just describe it in words). 
...
**One way to automate: when selecting metrics and tuning parameters, I would set some  
